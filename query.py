...
quizzes0 = Quizzes(is_final=True)
...
db.session.add_all([quizzes0, quizzes1, quizzes2, quizzes3, quizzes4, quizzes5])
...
multiple_choices_answer05 = Multiple_Choices_Answers_Class(choice="A", text="ant", multiple_choices=multiple_choices02)
multiple_choices_answer06 = Multiple_Choices_Answers_Class(choice="B", text="rabbit", multiple_choices=multiple_choices02)
multiple_choices_answer07 = Multiple_Choices_Answers_Class(choice="C", text="frog", multiple_choices=multiple_choices02)
multiple_choices_answer08 = Multiple_Choices_Answers_Class(choice="D", text="butterfly", multiple_choices=multiple_choices02)

multiple_choices_answer09 = Multiple_Choices_Answers_Class(choice="A", text="rabbit", multiple_choices=multiple_choices03)
multiple_choices_answer010 = Multiple_Choices_Answers_Class(choice="B", text="mouse", multiple_choices=multiple_choices03)
multiple_choices_answer011 = Multiple_Choices_Answers_Class(choice="C", text="ant", multiple_choices=multiple_choices03)
multiple_choices_answer012 = Multiple_Choices_Answers_Class(choice="D", text="frog", multiple_choices=multiple_choices03)

multiple_choices_answer013 = Multiple_Choices_Answers_Class(choice="A", text="ant", multiple_choices=multiple_choices04)
multiple_choices_answer014 = Multiple_Choices_Answers_Class(choice="B", text="rabbit", multiple_choices=multiple_choices04)
multiple_choices_answer015 = Multiple_Choices_Answers_Class(choice="C", text="elephant", multiple_choices=multiple_choices04)
multiple_choices_answer016 = Multiple_Choices_Answers_Class(choice="D", text="lion", multiple_choices=multiple_choices04)
...
multiple_choices_answer021 = Multiple_Choices_Answers_Class(choice="A", text="purple", multiple_choices=multiple_choices06)
multiple_choices_answer022 = Multiple_Choices_Answers_Class(choice="B", text="orange", multiple_choices=multiple_choices06)
multiple_choices_answer023 = Multiple_Choices_Answers_Class(choice="C", text="red", multiple_choices=multiple_choices06)
multiple_choices_answer024 = Multiple_Choices_Answers_Class(choice="D", text="green", multiple_choices=multiple_choices06)
